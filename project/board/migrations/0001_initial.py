    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='board.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
        ...
        migrations.AddField(
            model_name='post',
            name='upvotes',
            field=models.ManyToManyField(through='board.PostUpvote', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='CommentUpvote',
            fields=[
        ...
        migrations.AddField(
            model_name='comment',
            name='upvotes',
            field=models.ManyToManyField(through='board.CommentUpvote', to=settings.AUTH_USER_MODEL),
        ),
    ]
